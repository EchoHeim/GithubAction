...
def Email_SendMsg(Obj, Msg):  # 邮件发送
    # 发件人信息;(邮箱、密码、服务器)
    self_server = autosend_mail.SMTP(
        user="shilong_native@163.com", password="OPTZKTAEHISSJQOB", host="smtp.163.com"
    )
