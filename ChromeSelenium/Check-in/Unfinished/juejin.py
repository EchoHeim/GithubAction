...
def Sliding_Captcha(driver):
    ...
    backgroud_img = driver.find_element_by_xpath(
        "//*[@class='captcha_verify_img_slide react-draggable sc-VigVT ggNWOG']"
    )
...
def juejin():
    try:
        ...
        driver.find_element_by_xpath("//*[@name='loginPhoneOrEmail']").send_keys(
            username
        )
